...
<body>
	...
	<div class="tab_content">
		...
		<label for="tab03" style="width: 14vh; text-align: center;"><a id="blink" href="beenoticelist.action?cid=${cid }&b=b">게시판<%-- ${cid }&${b} --%></a></label> 
		
		<input type="hidden" id="b" name="b" value="${b }">
			
		<input type="radio" name="tabmenu" id="tab04">
		<label for="tab04"  style="width: 14vh; text-align: center;">회계</label> 
		
		<input type="radio" name="tabmenu" id="tab05"> 
		<label for="tab05"  style="width: 14vh; text-align: center;">사진첩</label> 
		
		<input type="radio" name="tabmenu" id="tab06"> 
		<label for="tab06"  style="width: 14vh; text-align: center;">회의</label>
		
		<input type="radio" name="tabmenu" id="tab07"> 
		<label for="tab07"  style="width: 14vh; text-align: center;">결산</label>
